...
START_TEST(acos_test_1_rand) {
  ...
  if (fabsl(x) > 1.0) {
    ...
    ck_assert_ldouble_eq_tol(s21_acos(x), acos(x), ACCURACY);
  }
}
END_TEST
...
Suite *suite_s21_acos(void) {
  ...
  tcase_add_loop_test(tc, acos_test_1_rand, 0, NUM_OF_TESTS / 20);
  tcase_add_loop_test(tc, acos_test_2_rand, 0, NUM_OF_TESTS);
  tcase_add_loop_test(tc, acos_test_3_rand, 0, NUM_OF_TESTS);
  tcase_add_loop_test(tc, acos_test_4_rand, 0, NUM_OF_TESTS);
  tcase_add_loop_test(tc, acos_test_5_rand, 0, NUM_OF_TESTS);
