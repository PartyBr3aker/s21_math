...
START_TEST(sqrt_test_4_one) {
  ck_assert_ldouble_eq_tol(s21_sqrt(1.0), sqrt(1.0), ACCURACY);
...
START_TEST(sqrt_test_6_large) {
  ck_assert_ldouble_eq_tol(s21_sqrt(10e+16), sqrt(10e+16), ACCURACY);
  ck_assert_ldouble_eq_tol(s21_sqrt(1.312e+16), sqrt(1.312e+16), ACCURACY);
}
END_TEST
...
Suite *suite_s21_sqrt(void) {
  ...
  tcase_add_loop_test(tc, sqrt_test_1, 0, NUM_OF_TESTS);
  tcase_add_loop_test(tc, sqrt_test_2, 0, NUM_OF_TESTS);
