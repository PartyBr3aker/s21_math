...
START_TEST(asin_test_1_rand) {
  ...
  if (s21_ldeq(x, 0.0)) {
    ck_assert_ldouble_eq_tol(s21_asin(x), 0.0, ACCURACY);
    ck_assert_ldouble_eq_tol(asin(x), 0.0, ACCURACY);
  } else if (fabsl(x) > 1.0) {
    ...
    ck_assert_ldouble_eq_tol(s21_asin(x), asin(x), ACCURACY);
  }
}
END_TEST
...
Suite *suite_s21_asin(void) {
  ...
  tcase_add_loop_test(tc, asin_test_1_rand, 0, NUM_OF_TESTS / 10);
  tcase_add_loop_test(tc, asin_test_2_rand, 0, NUM_OF_TESTS);
  tcase_add_loop_test(tc, asin_test_3_rand, 0, NUM_OF_TESTS);
  tcase_add_loop_test(tc, asin_test_4_rand, 0, NUM_OF_TESTS);
  tcase_add_loop_test(tc, asin_test_5_rand, 0, NUM_OF_TESTS);
